...
def run_inference_stage(config: Dict[str, Any]) -> None:
    ...
    stage_message(3, 3, "Running posterior inference for every model variant and saving raw records")
        ...
        for experiment in experiments:
            ...
            for cutoff in thresholds:
                ...
                posterior_trace = posterior_for_experiment(
                    ...
                    progress_prefix=(
                        f"model={model_id}, exp={experiment['experiment_id']:04d}, "
                        f"terms={n_terms}, mode={label},"
                    ),
                )
