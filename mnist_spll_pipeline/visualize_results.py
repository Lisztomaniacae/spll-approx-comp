...
def run_visualization_stage(config: Dict[str, Any]) -> None:
    ...
    add_exact_baseline_columns(summary_by_terms, ["model_id", "n_terms", "threshold_label", "cutoff"])

    stage_message(3, 3, "Writing tables and main/appended figure bundles")
    ...
    overhead_rows = plot_overhead_exact_vs_zero(
        ...
        term_counts=term_counts,
        threshold_order=threshold_order,
        output_path=appendix_dir / "overhead_exact_vs_zero_cutoff_by_terms.png",
    )
    ...
    write_bundle_readme(vis_root / "README.txt", term_counts, threshold_order)
